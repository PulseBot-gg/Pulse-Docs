...
<div style="display: inline-flex;align-items: center;justify-content: center;">
  <div style="margin: 15px;">
    <img class="sourceimage" src="https://image.winudf.com/v2/image/aW8uZ2V0eWFybi55YXJuX2ljb25fMTUxMjAyMzA3OF8wNTI/icon.png?w=170&fakeurl=1" alt="" style="width:75px;height:75px;border: none;border-radius: 75px;margin: auto;">
  </div>
  <div style="margin: 15px;">
...
<br>
<br>Example 1: `?play https://www.getyarn.io/yarn-clip/c8b6499c-40e3-435e-b5f2-c41e464144a6`
